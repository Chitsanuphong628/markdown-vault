...
export const I18N_MAIN = {
  en: {
    ...
    deleteNote: "Delete",
    createChart: "Chart",
    noteColor: "Theme Color",
    findInNote: "Find in document (⌘F)",
    ...
    shortcutsDesc: "Customize key combinations for quick navigation and actions across your vault.",
    shortcutsResetBtn: "Reset to Defaults",
    shortcutsRecording: "Press desired shortcut keys...",
  ...
  th: {
    ...
    editNote: "แก้ไข",
    deleteNote: "ลบโน้ต",
    createChart: "สร้างชาร์ต",
    noteColor: "สีของโน้ต",
    findInNote: "ค้นหาคำในโน้ตนี้ (⌘F)",
    findPlaceholder: "ค้นหาคำในเอกสาร...",
    noMatches: "ไม่พบคำค้นหา",
    ...
    tabMcp: "MCP & โปรโตคอล",
    shortcutsTitle: "ตั้งค่าคีย์ลัด (Keyboard Shortcuts)",
    shortcutsDesc: "ปรับแต่งปุ่มลัดสำหรับสั่งการทำงานและเคลื่อนที่อย่างรวดเร็วในคลังโน้ต",
    shortcutsResetBtn: "คืนค่าเริ่มต้น",
    shortcutsRecording: "กดปุ่มลัดใหม่บนคีย์บอร์ด...",
